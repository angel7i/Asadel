...
public class IUConfiguracion extends javax.swing.JInternalFrame 
{
    ...
    public IUConfiguracion() 
    {
        try 
        {
            descuento = new ArticulosTableModel(Control.SELECTDESCUENTO);
            sorter = new TableRowSorter< TableModel >(descuento);
        } 
        catch (SQLException ex) 
        {
            JOptionPane.showMessageDialog(null, "Error Config\n" + ex.getMessage(), "Error en la Base de Datos", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
            descuento.closeBD();
        }
    ...
    private void initComponents()
    {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/config.png"))); // NOI18N
        try
        {
            setSelected(true);
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/refresh2.png"))); // NOI18N
        ...
        jLabel6.setText("Destino de respaldo automatico");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            IUMain.control.setPrecioVar(jList1.getSelectedValue().toString(), new BigDecimal(jTextField1.getText()));
            jButton2.setEnabled(false);
            jTextField1.setEditable(false);
            jButton1.setText("Activar");
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            IUMain.control.setDescuentoGlobal(Integer.parseInt(jTextField2.getText()));
            IUMain.control.updateDescuentosGlobalArt();
            jButton4.setEnabled(false);
            jTextField2.setEditable(false);
            jButton3.setText("Activar");
            refresh();
    ...
    private void jTabbedPane1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPane1StateChanged
        // Cambio de Paneles
        if (IUMain.control != null)
        {
            if (jTabbedPane1.getSelectedIndex() == 0)
            {
                jTextField1.setText(IUMain.control.getPreciosVar(jList1.getSelectedValue().toString()).toString());
                jTextField4.setText(IUMain.control.getNameSystem("Nombre"));
            }
            else if (jTabbedPane1.getSelectedIndex() == 1)
            {
                jTextField3.requestFocus();
                jTextField2.setText(new BigDecimal("100.00").subtract(IUMain.control.getDescuentoGlobal()).setScale(0) + "");
            }
            else
            {
                jTextField6.setText(IUMain.control.getDirBackup());
            }
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        {
            IUMain.control.setNameSystem(jTextField4.getText());
            jButton7.setEnabled(false);
            jTextField4.setEditable(false);
            jButton6.setText("Activar");
            refresh();
    ...
    {//GEN-HEADEREND:event_jButton11ActionPerformed
        ...
        {
            if (IUMain.control.setDirBackup(jTextField6.getText()))
            {
    ...
    {//GEN-HEADEREND:event_jButton12ActionPerformed
        ...
        IUMain.control.setTheme(jComboBox1.getSelectedItem().toString());
    ...
    public void setDescuento(boolean estado, String id, int porciento)
    {
        if (estado)
        {
            if (porciento > 0 && porciento <= 100)
                IUMain.control.setDescuentoArticulo(id, true, porciento);
            else if (porciento == 0)
                IUMain.control.setDescuentoArticulo(id, false, porciento);
        }
        else
        {
            IUMain.control.removeDescuentoArticulo(id);
        }
