...
public class IUModificar extends javax.swing.JInternalFrame 
{
    ...
    private void initComponents()
    {
        ...
        setTitle("Modificar");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/edit2.png"))); // NOI18N
        try
        {
            setSelected(true);
        ...
        else
        {
            ...
            else
            {
                if (!(jTextField5.getText().isEmpty() || jTextField6.getText().isEmpty() || jTextField7.getText().isEmpty() || jTextArea1.getText().isEmpty()))
                {
                    ...
                    String info = jTextArea1.getText();
                    String tipo = (String)jComboBox2.getSelectedItem();
                    BigDecimal descuento = precio.multiply(IUMain.control.getDescuentoGlobal().divide(new BigDecimal("100.00"))).setScale(2);
    ...
    public void updateArticulo()
    {
        ...
        {
            case "Biografia":
                IUMain.control.updateBiografia(oldArticulo, newArticulo);
                break;
                
            case "Esquema":
                IUMain.control.updateEsquema(oldArticulo, newArticulo);
                break;
            ...
            case "Mapa Mural":
            case "MiniMapa":
                IUMain.control.updateMapa(oldArticulo, newArticulo);
                break;
                
            case "Monografia":
                IUMain.control.updateMonografia(oldArticulo, newArticulo);
                break;
                
            case "Relieve":
                IUMain.control.updateRelieve(oldArticulo, newArticulo);
                break;
                
            default:
                IUMain.control.deleteArticulo(oldArticulo);
                IUMain.control.updatePrecioArt(oldArticulo, newArticulo);
        }
    }
}
