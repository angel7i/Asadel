...
public class IUVentas extends javax.swing.JInternalFrame
{
    ...
    public void init()
    {
        try
        {
            ...
            //sorter = new TableRowSorter<>(ventas);
            initComponents();
            showTotal();
            setColumnas();
