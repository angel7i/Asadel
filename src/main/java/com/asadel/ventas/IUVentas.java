...
public class IUVentas extends javax.swing.JInternalFrame 
{
    ...
    private IUVentas() 
    {
        try
        {
            ventas = new ArticulosTableModel(Control.SELECTLISTA);
            filaSeleccionada = -1;
            initComponents();
            setColumnas();
            showTotal();            
    ...
    public static IUVentas getInstance()
    {
        if (ventana == null)
            return ventana = new IUVentas();
        else
            return ventana;
    }
    ...
    private void initComponents()
    {
        ...
        jTButton = new javax.swing.JToggleButton();
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cart2.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cancellist1.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/remove.png"))); // NOI18N
        ...
        jTButton.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jTButton.setText("Descuento");
        jTButton.setToolTipText("Descuento");
        jTButton.setMinimumSize(new java.awt.Dimension(0, 0));
        jTButton.addChangeListener(new javax.swing.event.ChangeListener()
        {
            public void stateChanged(javax.swing.event.ChangeEvent evt)
            {
                jTButtonStateChanged(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        jSpinner1.setNextFocusableComponent(jButton4);
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if (ventas.getRowCount() != 0)
        {
            ...
            else
            {
                if (pago == null)
                {
                    BigDecimal total = IUMain.control.getTotalVenta();
                    
                    if (jTButton.isSelected())
                    {
                        pago = new IUPago((Frame)IUMain.desktop.getParent().getParent().getParent().getParent(), true, total, true);
                        pago.invoke(total, true);
                    }
                    else
                    {
                        pago = new IUPago((Frame)IUMain.desktop.getParent().getParent().getParent().getParent(), true, total, false);
    ...
    {//GEN-HEADEREND:event_jTButtonActionPerformed
        // Lista
        if (jTButton.isSelected())
        {
            IUMain.control.setPrecioDescuentoLista();
            refresh(filaSeleccionada);
        }
        else
        {
            IUMain.control.setPrecioLista();
            refresh(filaSeleccionada);
        }
    }//GEN-LAST:event_jTButtonActionPerformed

    private void jTButtonStateChanged(javax.swing.event.ChangeEvent evt)//GEN-FIRST:event_jTButtonStateChanged
    {//GEN-HEADEREND:event_jTButtonStateChanged
        // Lista Escolar - Activar/Desactivar
        if (jTButton.isSelected())
        {
            jTButton.setText("Descuento");
            jTButton.setForeground(new java.awt.Color(0, 153, 51).darker());
        }
        else
        {
            jTButton.setText("Descuento");
            jTButton.setForeground(new java.awt.Color(204, 0, 0).darker());
        }
    }//GEN-LAST:event_jTButtonStateChanged
    ...
    public javax.swing.JToggleButton jTButton;
    ...
    public CellEditorListener Cell()
    {
        CellEditorListener celda = new CellEditorListener() 
        {
            ...
            public void editingStopped(ChangeEvent e) 
            {
                ...
                IUMain.control.updateArticuloLista(item, 2);
                refresh(filaSeleccionada);
            }
    ...
    private void sellItemExt()
    {
        ...
        else
        {
            ...
            item = new Articulo(id+"-AE", nombre, precio, (inf == null ? "" : inf), "Otros", cantidad, subtotal);      
    ...
    public void addItem(Articulo item)
    {
        ...
        {
            IUMain.control.insertArticuloLista(item);
        }
        else
        {
            IUMain.control.openLista();
            IUMain.control.insertArticuloLista(item);
        }     
    ...
    {        
        ...
        if (IUMain.control.updateArticuloLista(item, 0))
            filaSeleccionada = -1;
    ...
    {
        item = getItem(filaSeleccionada);
        IUMain.control.deleteArticuloLista(item);
        filaSeleccionada = -1;
        refresh(filaSeleccionada);
    }
    ...
    {
        jLabel2.setText(IUMain.control.getTotalVenta().toString());
    }
}
