...
public class IUAgregar extends JInternalFrame
{
    ...
    public boolean addItem()
    {
        ...
        else
        {
            ...
            {
                case "Biografia":
                    IUMain.control.insertBiografia(articulo);
                    break;

                case "Esquema":
                    IUMain.control.insertEsquema(articulo);
                    break;
                ...
                case "Mapa Mural":
                case "MiniMapa":
                    IUMain.control.insertMapa(articulo);
                    break;

                case "Monografia":
                    IUMain.control.insertMonografia(articulo);
                    break;

                case "Relieve":
                    IUMain.control.insertRelieve(articulo);
                    break;

                default:
                    IUMain.control.insertPrecioArt(articulo);
            }
        }
